#!/bin/bash
# Entrypoint for godiam dbg_msg_timings test
...
echo -e "${BLUE}==============================================${NC}"
echo -e "${BLUE}  godiam dbg_msg_timings + fifo_stats Test${NC}"
echo -e "${BLUE}  Tests message timing and queue tracking${NC}"
echo -e "${BLUE}==============================================${NC}"
echo ""

echo -e "${BLUE}[1/3] Starting godiam gw (with dbg_msg_timings + fifo_stats)...${NC}"
...
echo -e "${BLUE}[3/3] Starting godiam client (sends 5 test messages)...${NC}"
