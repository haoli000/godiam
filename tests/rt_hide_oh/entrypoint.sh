#!/bin/bash
# Entrypoint for godiam rt_hide_oh test
# Starts 3 godiam instances and validates Origin-Host hiding
...
echo -e "${BLUE}==============================================${NC}"
echo -e "${BLUE}  godiam rt_hide_oh Test${NC}"
echo -e "${BLUE}  Tests Origin-Host AVP hiding${NC}"
echo -e "${BLUE}==============================================${NC}"
echo ""

# Start GW (running rt_hide_oh, relaying enabled)
echo -e "${BLUE}[1/3] Starting godiam gw (with rt_hide_oh)...${NC}"
