#!/bin/bash
# Entrypoint for godiam rt_redirect test
...
echo -e "${BLUE}==============================================${NC}"
echo -e "${BLUE}  godiam rt_redirect Test${NC}"
echo -e "${BLUE}  Tests redirect indication caching${NC}"
echo -e "${BLUE}==============================================${NC}"
echo ""

echo -e "${BLUE}[1/3] Starting godiam gw (with rt_redirect)...${NC}"
...
echo -e "${BLUE}[3/3] Starting godiam client (sends 3 test messages)...${NC}"
